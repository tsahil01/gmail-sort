  ...
  return (
    ...
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-zinc-900 bg-opacity-50">
      <div className="bg-white dark:bg-zinc-950 rounded-lg shadow-lg w-full max-w-2xl p-4 md:p-6">
        ...
        <h3 className="font-bold text-gray-900 dark:text-gray-100 bg-blue-500 p-1 px-2 rounded-xl">{(selectedEmail.classify).toUpperCase()}</h3>
          <Button variant={"secondary"} size="icon" onClick={handleCloseCard}>
        ...
        <div className="max-h-96 bg-white rounded-md overflow-y-auto prose prose-sm prose-gray dark:prose-invert">
